...
public class PaperAction{
	...
	public String createByRandom(){
		...
		listRD = questionService.getQuestionsByType(course.getCsId(), "鍗曢��", "鍥伴�?");
		...
		listCD = questionService.getQuestionsByType(course.getCsId(), "澶氶��", "鍥伴�?");
		//2锛岄殢鏈鸿幏鍙栬瘯棰�?泦鍚�?
		System.out.println("2,闅忔�?鑾峰彇璇曢闆嗗�?");
		...
		//3,璁剧疆璇曢鍜岃瘯鍗风殑鍏崇�?
		System.out.println("3,璁剧疆璇曢鍜岃瘯鍗风殑鍏崇�?");
